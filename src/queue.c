...
#endif
#if !defined(__OPEN_SOURCE__) && OS_VENTURE_ENABLE
	DC_VTABLE_ENTRY(VENTURE_DRAIN,
		.do_invoke = _os_venture_drain_continuation_invoke),
#endif // !defined(__OPEN_SOURCE__) && OS_VENTURE_ENABLE
};
