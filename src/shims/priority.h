...
#define _PTHREAD_PRIORITY_THREAD_TYPE_MASK 0x88000000
#endif
...
#define DISPATCH_PRIORITY_FLAG_COOPERATIVE   ((dispatch_priority_t)0x08000000) // _PTHREAD_PRIORITY_COOPERATIVE_FLAG
